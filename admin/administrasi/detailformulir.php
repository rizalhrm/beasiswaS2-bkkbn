...
$dataf = mysqli_fetch_array($queryselect);
 ?>
  ...
  <div align="left">
    <a class="btn btn-warning btn-md pull-left" href="<?php if(isset($_SERVER['HTTP_REFERER'])){ echo $_SERVER['HTTP_REFERER']; } ?>" role="button">
          Kembali <span class="glyphicon glyphicon-circle-arrow-left"></span></a>
    <a class="btn btn-success btn-md pull-right" style="text-align:center;" href="laporan/detailformulir.php?nip=<?php echo $dataf['nip']; ?>" role="button">Cetak Laporan</a>
  </div>
  <br>
  <br>
