    ...
    <div class="panel panel-default">
      <div class="panel-body">
        <ul class="nav nav-tabs">
      	  ...
      	  <li role="presentation" class="active"><a href="kursus_ielts.php">Kursus IELTS</a></li>
        ...
        <?php
        if (isset($_POST['ubah'])) {
        include "ielts/ubahstatus.php";
        }
        else {
        $sql_ = "SELECT * from ielts A INNER JOIN formulir B ON B.nip=A.nip WHERE A.ket='Lolos Placement Test'";
...
if (isset($_POST['ubahstatus'])) {
  ...
  $queryupdate = "UPDATE ielts SET ket2='$keterangan2' WHERE nip = '$nip'";
  $update = mysqli_query($koneksi,$queryupdate);
  if ($update) {
  echo "<script>alert('Data Berhasil diubah'); location.href='kursus_ielts.php';</script>";
  }
  else {
    echo "<script>alert('DATA GAGAL DISIMPAN'); location.href='kursus_ielts.php';</script>";
  }
}
