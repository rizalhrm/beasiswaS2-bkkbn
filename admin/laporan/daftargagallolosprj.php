    ...
    <div class="panel panel-default">
      <div class="panel-body">
        <ul class="nav nav-tabs">
          ...
          <li role="presentation" class="active"><a href="daftargagallolosprj.php">Surat Perjanjian</a></li>
      	</ul>
        <br>
        <?php
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
              <div align="center" style="margin-top:-8px; margin-bottom:-7px">
                <a class="btn btn-success btn-xs" style="text-align:center;" href="laporan/cetak/gagalperjanjian.php" role="button">Cetak Laporan</a>
              </div>
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
              ...
              <table class="table table-bordered table-hover data" style="font-size:12px;">
                ...
                <tr>
                  ...
                  <td align="center"><input type="hidden" name="nip" value="<?php echo $data_gprj['nip']; ?>"><?php echo $data_gprj['nip']; ?></td>
...
if (isset($_POST['hapus'])) {
  ...
  echo "<script>alert('Data Berhasil dihapus'); location.href='daftargagallolosprj.php';</script>";
}
