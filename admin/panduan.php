...
<div class="row">
<div class="col-lg-12">
  <h3 class="page-header">Panduan Pendaftaran</h3>
</div>
</div>
<div class="row">
  <div class="col-lg-12">
    <div class="panel panel-default">
      <div class="panel-body">
        ...
        if (isset($_POST['simpan'])) {
          $judul = $_POST['judul'];
          $isi = $_POST['isi'];
          $updatea = "UPDATE informasi SET judul='$judul' , isi='$isi' where id='6'";
          $queryupdatea = mysqli_query($koneksi, $updatea);

          if ($queryupdatea) {
            echo "<script>alert('Data Berhasil Diubah'); location.href='panduan.php';</script>";
          }
          else {
        ...
        $syarat = "select * from informasi where id = '6'";
