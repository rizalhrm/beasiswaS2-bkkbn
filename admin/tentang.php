...
<div class="row">
<div class="col-lg-12">
  <h3 class="page-header">Tentang Kami</h3>
</div>
</div>
<div class="row">
  <div class="col-lg-12">
    <div class="panel panel-default">
      <div class="panel-body">
        ...
        if (isset($_POST['simpan'])) {
          $judul = $_POST['judul'];
          $isi = $_POST['isi'];
          $updatea = "UPDATE identitas_web SET judul='$judul' , isi='$isi' where id='3'";
          $queryupdatea = mysqli_query($koneksi, $updatea);

          if ($queryupdatea) {
            echo "<script>alert('Data Berhasil Diubah'); location.href='tentang.php';</script>";
          }
          else {
        ...
        $syarat = "select * from identitas_web where id = '3'";
