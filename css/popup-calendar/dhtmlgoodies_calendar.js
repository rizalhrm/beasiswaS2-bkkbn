...
function highlightSelect()
{
	if(this.className=='selectBox'){
		...
		this.getElementsByTagName('IMG')[0].src = '../css/popup-calendar/down_over.gif';
	}else{
		this.className = 'selectBox';
		this.getElementsByTagName('IMG')[0].src = '../css/popup-calendar/down.gif';
	}
...
function highlightArrow()
{
	if(this.src.indexOf('over')>=0){
		if(this.src.indexOf('left')>=0)this.src = '../css/popup-calendar/left.gif';
		if(this.src.indexOf('right')>=0)this.src = '../css/popup-calendar/right.gif';
	}else{
		if(this.src.indexOf('left')>=0)this.src = '../css/popup-calendar/left_over.gif';
		if(this.src.indexOf('right')>=0)this.src = '../css/popup-calendar/right_over.gif';
	}
}
...
{
	if(this.src.indexOf('over')>=0){
		this.src = '../css/popup-calendar/close.gif';
	}else{
		this.src = '../css/popup-calendar/close_over.gif';
	}
...
function writeTopBar()
{
	...
	img.src = '../css/popup-calendar/left.gif';
	...
	var img = document.createElement('IMG');
	img.src = '../css/popup-calendar/right.gif';
	img.onclick = switchMonth;
	img.onmouseover = highlightArrow;
	img.onmouseout = highlightArrow;
	...
	var img = document.createElement('IMG');
	img.src = '../css/popup-calendar/down.gif';
	...
	var img = document.createElement('IMG');
	img.src = '../css/popup-calendar/close.gif';
