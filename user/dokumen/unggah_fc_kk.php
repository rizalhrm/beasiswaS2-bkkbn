...
?>
  <ul class="breadcrumb wellwhite">
    ...
    <li><a href="berkasdokumen.php">Pengunggahan Dokumen</a> <span class="divider">/</span></li>
  	<li class="active">Unggah Kartu Keluarga</li>
  </ul>
  <?php
  ...
  <legend style="margin-bottom: 10px; font-size: 15px; font-weight: bold">Unggah Kartu Keluarga</legend>
  <div class="row-fluid">
    <?php
      ...
      Anda harus mengisi formulir terlebih dahulu
       ...
       onsubmit="if (eval(ukurandok )>1.5) { alert('Ukuran File ' + ukurandok + ' MB Melebihi Batas yaitu 1.5 MB.'); return false; } else { return pdf(); }">
         ...
         <div class="control-group" align="center">
           ...
           <input type="file" id="file" name="fc_kk" value="" accept=".pdf" required>
         </div>
         <div class="control-group" align="center">
  ...
  <?php
   if (isset($_POST['simpan'])) {
     $nip =$_POST['nip'];
     $fc_kk= $_FILES['fc_kk']['name'];
     $lokasi= "../file/dokumen/"."Kartu_Keluarga_".$nip."_".basename($fc_kk);
     $name_file = "Kartu_Keluarga_".$nip."_".basename($fc_kk);
     if($name_file){
     copy($_FILES['fc_kk']['tmp_name'],$lokasi);
     }
     $queryfc_kk="UPDATE dokumen SET fc_kk='$name_file' WHERE nip='$nip'";
     $simpanfc_kk=mysqli_query($koneksi,$queryfc_kk);
     if ($simpanfc_kk) {
