...
?>
  <ul class="breadcrumb wellwhite">
    ...
    <li><a href="berkasdokumen.php">Pengunggahan Dokumen</a> <span class="divider">/</span></li>
  	<li class="active">Unggah SK Pengangkatan</li>
  </ul>
  <?php
  ...
  <legend style="margin-bottom: 10px; font-size: 15px; font-weight: bold">Unggah SK Pengangkatan</legend>
  <div class="row-fluid">
    <?php
      ...
      Anda harus mengisi formulir terlebih dahulu
       ...
       onsubmit="if (eval(ukurandok )>1.5) { alert('Ukuran File ' + ukurandok + ' MB Melebihi Batas yaitu 1.5 MB.'); return false; } else { return pdf(); }">
         ...
         <div class="control-group" align="center">
           ...
           <input type="file" id="file" name="fc_sk" value="" accept=".pdf" required>
         </div>
         <div class="control-group" align="center">
  ...
  <?php
   if (isset($_POST['simpan'])) {
     $nip =$_POST['nip'];
     $fc_sk= $_FILES['fc_sk']['name'];
     $lokasi= "../file/dokumen/"."SK_Pengangkatan_".$nip."_".basename($fc_sk);
     $name_file = "SK_Pengangkatan_".$nip."_".basename($fc_sk);
     if($name_file){
     copy($_FILES['fc_sk']['tmp_name'],$lokasi);
     }
     $queryfc_sk="UPDATE dokumen SET fc_sk='$name_file' WHERE nip='$nip'";
     $simpanfc_sk=mysqli_query($koneksi,$queryfc_sk);
     if ($simpanfc_sk) {
