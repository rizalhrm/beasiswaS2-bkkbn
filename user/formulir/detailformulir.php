...
<div class="span12 wellwhite" style="margin-left: 0px">
  <legend style="margin-bottom: 10px; font-size: 15px; font-weight: bold">Detail Data Formulir Anda</legend>
<div class="row-fluid">
  ...
  <a class="btn btn-info pull-left" href="<?php if(isset($_SERVER['HTTP_REFERER'])){ echo $_SERVER['HTTP_REFERER']; } ?>" role="button"><i class="icon-arrow-left"></i>
    ...
    <table class="table table-bordered table-hover">
      <tr>
        <td width="24%"><b>NIP</b></td>
        <td width="73%"><?php echo $dataf['nip']; ?></td>
      </tr>
      <tr>
        <td><b>Nama</b></td>
      ...
      <tr>
        ...
        <td><?php
        $sql_f="SELECT * FROM data_bkkbn WHERE id_bkkbn='$dataf[provinsi_kantor]'";
      ...
      <tr>
        <td colspan="2">Di bawah ini adalah esai maksimal 500 kata yang terdiri dari (a) Latar belakang bidang studi Saudara; (b) Pengalaman Kerja yang menerangkan tentang tugas
          pokok dan fungsi di unit kerja Anda; (c) Alasan memilih program gelar prioritas Anda, dikaitkan dengan latar
          belakang pendidikan dan/atau tugas sehari-hari; (d) Rencana Saudara jika telah menyelesaikan Program Gelar S2 Prioritas
          pertama Anda dikaitkan dengan tugas pokok dan fungsi sehari-hari dan manfaatnya untuk BKKBN.</td>
      </tr>
      <tr>
        <td colspan="2"><?php echo $dataf['esai']; ?></td>
      </tr>
    </table>
    <a class="btn btn-info pull-left" href="<?php if(isset($_SERVER['HTTP_REFERER'])){ echo $_SERVER['HTTP_REFERER']; } ?>" role="button"><i class="icon-arrow-left"></i>
      Kembali</a>
