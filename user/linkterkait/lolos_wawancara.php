...
<ul class="breadcrumb wellwhite">
  <li><a href="beranda.php">Beranda</a> <span class="divider">/</span></li>
	<li class="active">Daftar Calon Penerima Beasiswa Lolos Seleksi Wawancara</li>
</ul>

<div class="span12 wellwhite" style="margin-left: 0px">
<legend style="margin-bottom: 10px; font-size: 15px; font-weight: bold">Daftar Calon Penerima Beasiswa Lolos Seleksi Wawancara</legend>
...
<div class="row-fluid">
  <table align="center" class="table table-bordered table-hover" style="font-size:12px;">
    ...
    <tbody>
    <?php
       $select = "SELECT * from ielts A INNER JOIN formulir B ON B.nip=A.nip";
