...
?>
  <ul class="breadcrumb wellwhite">
    ...
    <li><a href="berkasdokumen.php">Pengunggahan Surat Perjanjian</a> <span class="divider">/</span></li>
  	<li class="active">Unggah Surat Perjanjian</li>
  </ul>
  <?php
  ...
  <legend style="margin-bottom: 10px; font-size: 15px; font-weight: bold">Unggah Surat Perjanjian</legend>
  <div class="row-fluid">
    <?php
    ...
    elseif ($lolosprj['status_pendaftaran_ln']=='Sudah didaftarkan' && $databatas['surat_perjanjian']=='1') {
       ...
       onsubmit="if (eval(ukuran )>1) { alert('Ukuran File ' + ukuran + ' MB Melebihi Batas yaitu 1 MB.'); return false; } else { return pdf(); }">
         ...
         <div class="control-group" align="center">
           ...
           <input type="file" id="file" name="prj" value="" accept=".pdf" required>
         </div>
         <div class="control-group" align="center">
  ...
  <?php
   if (isset($_POST['simpan'])) {
     $nip =$_POST['nip'];
     $prj= $_FILES['prj']['name'];
     $lokasi= "../file/dokumen/"."Surat_Perjanjian_".$nip."_".basename($prj);
     $name_file = "Surat_Perjanjian_".$nip."_".basename($prj);
     if($name_file){
     copy($_FILES['prj']['tmp_name'],$lokasi);
     }
     $querydrh="UPDATE surat_perjanjian SET perjanjian='$name_file' WHERE nip='$nip'";
